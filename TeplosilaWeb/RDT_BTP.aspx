    ...
    <div class="container-fluid">
        <form id="form2" runat="server" novalidate="novalidate">
            ...
            <div class="row jumbotron">
                <div class="col-xs-12 col">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:Label ID="LabelCustomValid" runat="server" ForeColor="Red"
                                                            Text="Суммарные потери давления на регуляторе и регулируемом участке превышают допустимый перепад да" Visible="False"></asp:Label>
                                                    </div>
                                                </div>
                                        </div>
                                        <div class="row">
                    ...
                    <div>
                        <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                            <ContentTemplate>
                                <div class="rte col border" id="calcr" runat="server" visible="false">
                    ...
                    <div>
                        <asp:UpdatePanel ID="UpdatePanel13" runat="server">
                            <ContentTemplate>
                                <div class="col border border-non-bottom" id="fpr1" runat="server" visible="false">
                        ...
                        <asp:UpdatePanel ID="UpdatePanel14" runat="server">
                            <ContentTemplate>
                                <div class="col border border-non-top" id="fpr2" runat="server" visible="false">
                                    <div class="flow-radio-label">
                                    ...
                                    <div class="col panel-hide sub-col" id="fpr2_1" runat="server">
                                        ...
                                        <asp:DropDownList ID="fprDropDownList2" runat="server" AutoPostBack="True"
                                            ...
                                            <asp:ListItem Style="display: none;" class="dropdown-item">Вт</asp:ListItem>
                ...
                <div class="col-md-12">
                    <asp:UpdatePanel ID="UpdatePanel16" class="block-img" runat="server" Visible="false">
                        <ContentTemplate>
                ...
                <div class="col-12">
                    <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:Button ID="rButton" runat="server" Text="Рассчитать" Width="100%"
