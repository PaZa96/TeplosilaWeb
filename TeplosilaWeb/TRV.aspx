        ...
        <div class="col-xs-12 col-sm-10">
          <div class="col border">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
              <ContentTemplate>
                ...
                <asp:RequiredFieldValidator ID="spvRequiredFieldValidator1" runat="server"
                  ControlToValidate="spvRadioButtonList1" Display="Dynamic" ErrorMessage="Выберите необходимое значение"
          ...
          <div class="col border">
            <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
              <ContentTemplate>
                ...
                <asp:RequiredFieldValidator ID="rpvRequiredFieldValidator1" runat="server"
                  ControlToValidate="rpvRadioButtonList1" Display="Dynamic" ErrorMessage="Выберите необходимое значение"
                  ForeColor="Red" SetFocusOnError="True">
                  Выберите необходимое значение</asp:RequiredFieldValidator>
              </ContentTemplate>
            </asp:UpdatePanel>
          ...
          <div class="col border">
            <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
              <ContentTemplate>
                <asp:Label ID="Label3" runat="server" Text="Область применения (система) / Схема присоединения">
                </asp:Label><br />
                <asp:RadioButton ID="aaRadioButton1" runat="server" Text="Горячее водоснабжение" AutoPostBack="True"
                  required="required" OnCheckedChanged="aaRadioButton1_CheckedChanged" />
                <asp:RadioButtonList ID="aa1RadioButtonList1" required="required" CssClass="childRadio" runat="server"
                ...
                <asp:RadioButtonList ID="aa2RadioButtonList1" required="required" CssClass="childRadio" runat="server"
                  RepeatDirection="Horizontal" Enabled="False" AutoPostBack="True"
                ...
                <asp:RadioButton ID="aaRadioButton3" runat="server" Text="Вентиляция" AutoPostBack="True"
                  required="required" OnCheckedChanged="aaRadioButton3_CheckedChanged" />
                <asp:RadioButtonList ID="aa3RadioButtonList1" required="required" CssClass="childRadio" runat="server"
                  RepeatDirection="Horizontal" Enabled="False" AutoPostBack="True"
                  OnSelectedIndexChanged="aa3RadioButtonList1_SelectedIndexChanged">
                  <asp:ListItem>Зависимая</asp:ListItem>
                  <asp:ListItem>Независимая (через теплообменник)</asp:ListItem>
                </asp:RadioButtonList>
                <asp:CustomValidator ID="aaCustomValidator8" runat="server" ControlToValidate="aa1RadioButtonList1"
                  Display="Dynamic" ErrorMessage="CustomValidator" ForeColor="Red" SetFocusOnError="True">
                </asp:CustomValidator>
              </ContentTemplate>
            </asp:UpdatePanel>
          </div>
          <div class="col border">
            <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
              <ContentTemplate>
                ...
                <asp:RequiredFieldValidator ID="tvRequiredFieldValidator1" runat="server"
                  ControlToValidate="tvRadioButtonList1" Display="Dynamic" ErrorMessage="Выберите необходимое значение"
                  ForeColor="Red" SetFocusOnError="True">
                  Выберите необходимое значение</asp:RequiredFieldValidator>
              </ContentTemplate>
            </asp:UpdatePanel>
            ...
            <asp:UpdatePanel ID="UpdatePanel5" runat="server" UpdateMode="Conditional">
              <ContentTemplate>
                ...
                <div class="row">
                  ...
                  <div class="col-9">
                    <br />
                    <asp:TextBox ID="ws2TextBox1" runat="server" step="0.01"  Enabled="False" type="number" required="required" TextMode="Number"></asp:TextBox>
                    ...
                    <asp:RangeValidator ID="wsRangeValidator1" runat="server" Display="Dynamic"
                      ControlToValidate="ws2TextBox1" ErrorMessage="Значение должно находится в диапазоне от 5% до 65%"
                      ForeColor="Red" MaximumValue="65" MinimumValue="5" SetFocusOnError="True" Type="Double">
                    </asp:RangeValidator>
                    <br />
                    <asp:TextBox ID="ws2TextBox2" runat="server" Enabled="False" step="0.01"  type="number" required="required" TextMode="Number"></asp:TextBox>
                    <asp:Label ID="Label7" runat="server" Text="&#8451; (от 0&#8451; до 150&#8451;)">
                    </asp:Label>&nbsp;&nbsp;&nbsp;
                    <asp:RangeValidator ID="wsRangeValidator2" runat="server" ControlToValidate="ws2TextBox2"
                      Display="Dynamic"
                      ErrorMessage="Значение должно находится в диапазоне от 0&amp;#8451 до 150&amp;#8451"
                      ForeColor="Red" MaximumValue="150" MinimumValue="0" SetFocusOnError="True" Type="Double">
                    </asp:RangeValidator>
                    <br />
                    <asp:RequiredFieldValidator ID="ws2RequiredFieldValidator1" runat="server"
            ...
            <div class="col">
              <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                <ContentTemplate>
                  ...
                  <asp:TextBox ID="lpvTextBox2" runat="server" Enabled="False" step="0.01"  type="number" TextMode="Number"
                  ...
                  <br />
                  <asp:RangeValidator ID="lpvRangeValidator2" runat="server" ControlToValidate="lpvTextBox2"
                    Display="Dynamic" ErrorMessage="Неверно указано значение давления" ForeColor="Red" MinimumValue="1"
                    SetFocusOnError="True" MaximumValue="999999999999">Неверно
            ...
            <div class="col">
              <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                <ContentTemplate>
                  ...
                  <asp:TextBox ID="lpvTextBox21" runat="server" Enabled="False" step="0.01"  type="number" required="required" TextMode="Number"></asp:TextBox>
                  ...
                  <br />
                  <asp:RangeValidator ID="lpvRangeValidator21" runat="server" ControlToValidate="lpvTextBox21"
                    Display="Dynamic" ErrorMessage="Неверно указано значение давления" ForeColor="Red" MinimumValue="1"
                    SetFocusOnError="True" MaximumValue="99999999">Неверно указано
            ...
            <div class="col">
              <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                <ContentTemplate>
                  ...
                  <asp:TextBox ID="lpvTextBox1" runat="server" Enabled="False" step="0.01"  type="number" required="required" TextMode="Number"></asp:TextBox>
                  ...
                  <br />
                  <asp:RangeValidator ID="lpvRangeValidator1" runat="server" ControlToValidate="lpvTextBox1"
                    Display="Dynamic" ErrorMessage="Неверно указано значение давления" ForeColor="Red"
                    MaximumValue="99999999" MinimumValue="1" SetFocusOnError="True">Неверно указано
                    значение давления</asp:RangeValidator>

                  <asp:CustomValidator ID="lpvCustomValidator1" runat="server" ControlToValidate="lpvTextBox1"
                    Display="Dynamic" ErrorMessage="CustomValidator" ForeColor="Red" SetFocusOnError="True"
          ...
          <div class="col border">
            <asp:Label ID="Label20" runat="server" Text="Расчёт регулирующего клапана на кавариацию:">
            </asp:Label>
            <div class="col">
              <asp:UpdatePanel ID="UpdatePanel12" runat="server">
                <ContentTemplate>
                  <asp:Label ID="Label26" runat="server" Text="Давление перед клапаном:"></asp:Label>
                  <br />
                  <asp:Label ID="Label21" runat="server" Text="P' = "></asp:Label>
                  <asp:TextBox ID="calcvTextBox1" runat="server" Enabled="False" step="0.01" type="number" required="required" TextMode="Number"></asp:TextBox>
                  ...
                  <asp:RangeValidator ID="calcvRangeValidator1" runat="server" ControlToValidate="calcvTextBox1"
                    Display="Dynamic" ErrorMessage="Неверно указано значение давления" ForeColor="Red"
                    MaximumValue="99999999" MinimumValue="0,000001" SetFocusOnError="True">Неверно указано
                    значение давления</asp:RangeValidator>

                  <asp:CustomValidator ID="calcvCustomValidator1" runat="server" ErrorMessage="CustomValidator"
                    ControlToValidate="calcvTextBox1" Display="Dynamic" ForeColor="Red" SetFocusOnError="True"
                    OnServerValidate="calcvCustomValidator1_ServerValidate"></asp:CustomValidator>
                  <br />
                  <asp:Label ID="Label22" runat="server" Text="Максимальная температура теплоносителя через клапан:">
                  </asp:Label><br />
                  <asp:Label ID="Label23" runat="server" Text="T1 = "></asp:Label>
                  <asp:TextBox ID="calcvTextBox2" runat="server" step="0.01"  Enabled="False" type="number" required="required" TextMode="Number"></asp:TextBox>
                  <asp:Label ID="Label24" runat="server" Text=" &#8451;"></asp:Label>
                  <br />
                  <asp:RangeValidator ID="calcvRangeValidator2" runat="server"
                    ErrorMessage="Неверно указано значение температуры" ControlToValidate="calcvTextBox2"
                    Display="Dynamic" ForeColor="Red" MaximumValue="9999999" MinimumValue="0" SetFocusOnError="True"
                    Type="Double">
                    Неверно указано значение температуры</asp:RangeValidator>
                  <asp:CustomValidator ID="calcvCustomValidator2" runat="server" ErrorMessage="CustomValidator"
                    ControlToValidate="calcvTextBox2" Display="Dynamic" ForeColor="Red" SetFocusOnError="True"
                    OnServerValidate="calcvCustomValidator2_ServerValidate"></asp:CustomValidator>
          ...
          <div class="col border">
            <div>
              <asp:UpdatePanel ID="UpdatePanel13" runat="server">
                <ContentTemplate>
                  <asp:RadioButton ID="fvRadioButton1" runat="server" Text="Задать max величину расхода через клапан:"
                    AutoPostBack="True" OnCheckedChanged="fvRadioButton1_CheckedChanged" /><br />
                  <div class="col">
                    <asp:Label ID="Label28" runat="server" Text="Gкл = "></asp:Label>
                    <asp:TextBox ID="fvTextBox1" runat="server" step="0.01"  Enabled="False" type="number" required="required" TextMode="Number"></asp:TextBox>
                    ...
                    <br />
                    <asp:RangeValidator ID="RangeValidator9" runat="server" ControlToValidate="fvTextBox1"
                      Display="Dynamic" ErrorMessage="Неверно указано значение давления" ForeColor="Red"
              ...
              <asp:UpdatePanel ID="UpdatePanel14" runat="server">
                <ContentTemplate>
                  ...
                  <div class="col table-responsive-md">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="text-center">
                            ...
                            <asp:TextBox ID="fvTextBox2" runat="server" step="0.01"  Enabled="False" type="number" Width="60px"
                          ...
                          <td class="text-center">
                            ...
                            <asp:TextBox ID="fvTextBox3" runat="server" Enabled="False" step="0.01"  type="number" Width="60px"
                              required="required" TextMode="Number"></asp:TextBox>
                        ...
                        <tr>
                          ...
                          <td class="text-center">
                            ...
                            <asp:TextBox ID="fvTextBox4" runat="server" Enabled="False" step="0.01"  type="number" Width="60px"
                              required="required" TextMode="Number"></asp:TextBox>
                          ...
                          <td class="text-center">
                            ...
                            <asp:TextBox ID="fvTextBox5" runat="server" Enabled="False" step="0.01"  type="number" Width="60px"
                              required="required" TextMode="Number"></asp:TextBox>
                        ...
                        <tr>
                          ...
                          <td class="text-center">
                            ...
                            <asp:TextBox ID="fvTextBox6" runat="server" Enabled="False" step="0.01"  type="number" Width="60px"
                              required="required" TextMode="Number"></asp:TextBox>
                          ...
                          <td class="text-center">
                            ...
                            <asp:TextBox ID="fvTextBox7" runat="server" Enabled="False" step="0.01"  type="number" Width="60px"
                              required="required" TextMode="Number"></asp:TextBox>
                        ...
                        <tr>
                          ...
                          <td class="text-center">
                            ...
                            <asp:TextBox ID="fvTextBox8" runat="server" Enabled="False" step="0.01"  type="number" Width="60px"
                              required="required" TextMode="Number"></asp:TextBox>
                          ...
                          <td class="text-center">
                            ...
                            <asp:TextBox ID="fvTextBox9" runat="server" Enabled="False" step="0.01"  type="number" Width="60px"
                              required="required" TextMode="Number"></asp:TextBox>
                    ...
                    <asp:CustomValidator ID="tvCustomValidator1" runat="server" ControlToValidate="tvRadioButtonList1"
                      Display="Dynamic" ErrorMessage="CustomValidator" ForeColor="Red" SetFocusOnError="True"
                    ...
                    <asp:TextBox ID="fvTextBox10" runat="server" Enabled="False" step="0.01"  required="required"
                      OnTextChanged="fvTextBox10_TextChanged" TextMode="Number"></asp:TextBox>
                    ...
                    <asp:RangeValidator ID="fvRangeValidator2" runat="server" ControlToValidate="fvTextBox10"
                      Display="Dynamic" ErrorMessage="Неверно указано значение давления" ForeColor="Red"
                    ...
                    <asp:TextBox ID="fvTextBox11" runat="server" Enabled="False" step="0.01"  ReadOnly="True" TextMode="Number"></asp:TextBox>
          ...
          <div class="col border">
            ...
            <div class="col">
              <asp:UpdatePanel ID="UpdatePanel15" runat="server">
                <ContentTemplate>
                  ...
                  <asp:Label ID="Label51" runat="server" Text="Наличие возвратного механизма (функция безопасности):">
                  </asp:Label>
            ...
            <asp:UpdatePanel ID="UpdatePanel9" runat="server">
              <ContentTemplate>
                <asp:Label ID="LabelError" runat="server" Font-Bold="True" Font-Size="Medium" Font-Strikeout="False"
                ...
                <asp:Label ID="Label52" runat="server" Enabled="False" Text="Результаты расчёта" Visible="False"
                ...
                <div class="table-responsive-lg" onclick="ShowBTN()">
                  <asp:GridView ID="GridView2" CssClass="table" runat="server" OnRowDataBound="GridView2_RowDataBound"
                    OnSelectedIndexChanged="GridView2_SelectedIndexChanged" AutoGenerateSelectButton="True"
