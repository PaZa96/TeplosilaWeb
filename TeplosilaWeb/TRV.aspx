                        ...
                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                            <ContentTemplate>
                                <asp:Label ID="Label3" runat="server"
                                    Text="Область применения (система) / Схема присоединения"></asp:Label><br />
                        ...
                        <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                            <ContentTemplate>
                                ...
                                <asp:RangeValidator ID="wsRangeValidator1" runat="server" Display="Dynamic"
                                    ...
                                    MaximumValue="65" MinimumValue="5" SetFocusOnError="True" Type="Double">
                                </asp:RangeValidator>
                                <br />
                        ...
                        <div class="col">
                            <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                <ContentTemplate>
                                    ...
                                    <asp:TextBox ID="lpvTextBox2" runat="server" Enabled="False" type="number"
                                        TextMode="Number" required="required"></asp:TextBox>
                                    <asp:DropDownList ID="lpvDropDownList2" runat="server" AutoPostBack="True"
                                        Enabled="False" OnSelectedIndexChanged="lpvDropDownList2_SelectedIndexChanged">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                <ContentTemplate>
                                    ...
                                    <asp:RangeValidator ID="lpvRangeValidator21" runat="server"
                                        ...
                                        ErrorMessage="Неверно указано значение давления" ForeColor="Red"
                                        MinimumValue="1" SetFocusOnError="True" MaximumValue="99999999">Неверно указано
                        ...
                        <div class="col">
                            <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                                <ContentTemplate>
                                    ...
                                    <asp:TextBox ID="lpvTextBox1" runat="server" Enabled="False" type="number"
                                        required="required"></asp:TextBox>
                                    <asp:DropDownList ID="lpvDropDownList1" runat="server" AutoPostBack="True"
                                        Enabled="False" OnSelectedIndexChanged="lpvDropDownList1_SelectedIndexChanged">
                                        <asp:ListItem>выбрать</asp:ListItem>
                                        <asp:ListItem>МПа</asp:ListItem>
                                        <asp:ListItem>кПа</asp:ListItem>
                                        <asp:ListItem>бар</asp:ListItem>
                                    ...
                                    <asp:CustomValidator ID="lpvCustomValidator1" runat="server"
                                        ControlToValidate="lpvTextBox1" Display="Dynamic" ErrorMessage="CustomValidator"
                        ...
                        <div class="col">
                            <asp:UpdatePanel ID="UpdatePanel12" runat="server">
                                <ContentTemplate>
                                    ...
                                    <asp:TextBox ID="calcvTextBox1" runat="server" Enabled="False" type="number"
                                        required="required"></asp:TextBox>
                                    ...
                                    <asp:Label ID="Label22" runat="server"
                                        Text="Максимальная температура теплоносителя через клапан:"></asp:Label><br />
                                    <asp:Label ID="Label23" runat="server" Text="T1 = "></asp:Label>
                                    <asp:TextBox ID="calcvTextBox2" runat="server" Enabled="False" type="number"
                                        required="required"></asp:TextBox>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel13" runat="server">
                                <ContentTemplate>
                                    ...
                                    <div class="col">
                                        ...
                                        <asp:TextBox ID="fvTextBox1" runat="server" Enabled="False" type="number"
                                            required="required"></asp:TextBox>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel14" runat="server">
                                <ContentTemplate>
                                    ...
                                    <div class="col table-responsive-md">
                                        ...
                                        <asp:TextBox ID="fvTextBox10" runat="server" Enabled="False" required="required"
                                            OnTextChanged="fvTextBox10_TextChanged"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="fvTextBox11" runat="server" Enabled="False" ReadOnly="True">
                                        </asp:TextBox>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel15" runat="server">
                                <ContentTemplate>
                                    ...
                                    <asp:Label ID="Label51" runat="server"
                                        Text="Наличие возвратного механизма (функция безопасности):"></asp:Label>
